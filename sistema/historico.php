            ...
            <tbody>
                <?php
                    ...
                    while($user_data = mysqli_fetch_assoc($result)){
                        //tratamento de datas
                        $dataEmprestimo = date('d/m/Y',strtotime($user_data["dataEmprestimo"]));
                        $dataDevolPrevista = date('d/m/Y',strtotime($user_data["dataDevolPrevista"]));
                       

                        echo "<tr>";
                        echo "<td>". $count++ . "</td>";
                        echo "<td>". $dataEmprestimo. "</td>";
                        echo "<td>".$dataDevolPrevista. "</td>";
                        ...
                        echo "<td>
                        <a class='btn btn-sm btn-success' title='devolver' href='../emprestimo/devolucao.php?idmateriais=$user_data[idMateriais]'>
